                ...
                {
                    {
                        ...
                        new[]
                        {
                            new TagHelperAttributeDescriptor
                            {
                                ...
                                TypeName = RuntimeTypeInfo.GetFullName(typeof(IDictionary<string, string>).FullName)
                            },
                            new TagHelperAttributeDescriptor
                            {
                                Name = "dictionary-property-",
                    ...
                    },
                    {
                        ...
                        new[]
                        {
                            new TagHelperAttributeDescriptor
                            {
                                ...
                                TypeName = RuntimeTypeInfo.GetFullName(typeof(Dictionary<string, object>).FullName)
                            },
                            new TagHelperAttributeDescriptor
                            {
                                Name = "valid-name2",
                                PropertyName = nameof(MultipleValidHtmlAttributePrefix.DictionarySubclassProperty),
                                TypeName = RuntimeTypeInfo.GetFullName(typeof(DictionarySubclass).FullName)
                            },
                            new TagHelperAttributeDescriptor
                            {
                                Name = "valid-name3",
                                PropertyName = nameof(MultipleValidHtmlAttributePrefix.DictionaryWithoutParameterlessConstructorProperty),
                                TypeName = RuntimeTypeInfo.GetFullName(typeof(DictionaryWithoutParameterlessConstructor).FullName)
                            },
                            new TagHelperAttributeDescriptor
                            {
                                Name = "valid-name4",
                                PropertyName = nameof(MultipleValidHtmlAttributePrefix.GenericDictionarySubclassProperty),
                                TypeName = RuntimeTypeInfo.GetFullName(typeof(GenericDictionarySubclass<object>).FullName)
                            },
                            new TagHelperAttributeDescriptor
                            {
                                Name = "valid-name5",
                                PropertyName = nameof(MultipleValidHtmlAttributePrefix.SortedDictionaryProperty),
                                TypeName = RuntimeTypeInfo.GetFullName(typeof(SortedDictionary<string, int>).FullName)
                            },
                            new TagHelperAttributeDescriptor
                            {
                                Name = "valid-name6",
