...
namespace Microsoft.AspNet.Razor.Runtime.TagHelpers
{
    ...
    {
        [Fact]
        public async Task TagHelperRunner_RunAsyncProcessesAllTagHelpers()
        {
            // Arrange
        ...
        [Fact]
        public async Task TagHelperRunner_RunAsyncAllowsModificationOfTagHelperOutput()
        {
            // Arrange
            var runner = new TagHelperRunner();
            var executionContext = new TagHelpersExecutionContext("p");
        ...
        [Fact]
        public async Task TagHelperRunner_RunAsyncAllowsDataRetrievalFromTagHelperContext()
        {
            // Arrange
            var runner = new TagHelperRunner();
            var executionContext = new TagHelpersExecutionContext("p");
        ...
        [Fact]
        public async Task TagHelperRunner_RunAsyncWithContentSetsOutputsContent()
        {
            // Arrange
            var runner = new TagHelperRunner();
            var executionContext = new TagHelpersExecutionContext("p");
