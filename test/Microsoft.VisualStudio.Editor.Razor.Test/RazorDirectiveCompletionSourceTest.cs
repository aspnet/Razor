...
namespace Microsoft.VisualStudio.Editor.Razor
{
    public class RazorDirectiveCompletionSourceTest : ForegroundDispatcherTestBase
    {
        ...
        [Fact]
        public void IsDirectiveCompletableSymbol_ReturnsTrueForCSharpIdentifiers()
        {
            // Arrange
            var csharpSymbol = new CSharpSymbol("model", CSharpSymbolType.Identifier);

            // Act
            var result = RazorDirectiveCompletionSource.IsDirectiveCompletableSymbol(csharpSymbol);
        ...
        [Fact]
        public void IsDirectiveCompletableSymbol_ReturnsTrueForCSharpMarkerSymbols()
        {
            // Arrange
            var csharpSymbol = new CSharpSymbol(string.Empty, CSharpSymbolType.Unknown);
        ...
        [Fact]
        public void IsDirectiveCompletableSymbol_ReturnsFalseForNonCSharpSymbols()
        {
            // Arrange
            var symbol = Mock.Of<ISymbol>();

            // Act
            var result = RazorDirectiveCompletionSource.IsDirectiveCompletableSymbol(symbol);
        ...
        [Fact]
        public void IsDirectiveCompletableSymbol_ReturnsFalseForInvalidCSharpSymbols()
        {
            // Arrange
            var csharpSymbol = new CSharpSymbol("~", CSharpSymbolType.Tilde);
