...
namespace Microsoft.VisualStudio.LanguageServices.Razor
{
    public class VsSolutionUpdatesProjectSnapshotChangeTriggerTest
    {
        ...
        public void Initialize_AttachesEventSink()
        {
            ...
            buildManager
                .Setup(b => b.AdviseUpdateSolutionEvents(It.IsAny<VsSolutionUpdatesProjectSnapshotChangeTrigger.SolutionUpdateEventSink>(), out cookie))
        ...
        public void UpdateProjectCfg_Done_KnownProject_Invokes_ProjectBuildComplete()
        {
            ...
            var eventSink = new VsSolutionUpdatesProjectSnapshotChangeTrigger.SolutionUpdateEventSink(projectManager.Object, projectService.Object);

            // Act
            eventSink.UpdateProjectCfg_Done(Mock.Of<IVsHierarchy>(), Mock.Of<IVsCfg>(), Mock.Of<IVsCfg>(), 0, 0, 0);
