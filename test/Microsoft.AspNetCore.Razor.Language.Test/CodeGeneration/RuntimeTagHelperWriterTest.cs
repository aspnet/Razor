...
<input name=""value"" />";
            ...
            var node = irDocument.Children.Last().Children[1] as AddTagHelperHtmlAttributeIRNode;
...
",
        ...
        private static CSharpRenderingContext GetCSharpRenderingContext(TagHelperWriter writer)
        {
